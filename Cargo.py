...
trav = input(" Would you like the package to travel by air ($0.36 per km)\n or by road ($0.25 per km)? \n(Please answer with  either 'air' or with 'road') : ")
trav = (trav.lower()) 
if trav == "air" :
   cost += float(0.36)
elif trav == "road" :
...
print(" The total price for the package amounts to $"+(str(totalCost)) + "\n thank you " + name + " for using us, please proceed to payment options.")